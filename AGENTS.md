...
- **Laura or Ilona answers about Disney / DCP Vault withdrawal:** read [`docs/disney-dcp-withdrawal-answer-routing.md`](docs/disney-dcp-withdrawal-answer-routing.md) before responding or acting, including when Albert relays the answer in a new chat. Record the sanitized answer and its provenance at the durable issue named there; classify follow-up from its actual scope. Never contact anyone on Albert's behalf or infer confirmed vendor withdrawal or legal rights from disappearance alone.
