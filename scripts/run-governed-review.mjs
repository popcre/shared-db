...
export function wrapperVerdictContractArgs(wrapper,args,headSha){
  ...
  // Say exactly what is missing and the shape that works (#498 item 13).
  ...
  if((name!=='ai-deepseek-agent'||list[0]==='reply')&&(!sessionName||sessionName.startsWith('-')))throw new Error(`${name} ${list[0]} is missing <session-name>. Usage after the runner options: ${usage}`)
