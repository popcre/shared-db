...
test('a wrapper call missing new <session-name> is refused with the usage line (#498)',()=>{
  ...
  assert.throws(()=>wrapperVerdictContractArgs('ai-qwen',['new','--prompt-file','p.md'],head),/ai-qwen new is missing <session-name>\. Usage after the runner options: -- new <session-name>/)
  assert.throws(()=>wrapperVerdictContractArgs('ai-deepseek-agent',['reply','--review'],head),/ai-deepseek-agent reply is missing <session-name>.*-- reply <session-name>/)
