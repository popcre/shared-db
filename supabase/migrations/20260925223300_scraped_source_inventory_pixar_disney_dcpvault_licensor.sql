-- #3539: Pixar under Disney; DCP Vault licensor from source system.
--
-- derived-from: 20260917144950
--
-- Changes to api.db_data_admin_scraped_source_inventory grouping (all three
-- entity branches: property, character, style_guide):
--   1. Pixar belongs to Disney. licensor_key pixar/pixar-opa groups to
--      disney/Disney. Section labels say Disney (Pixar in parentheses).
