...
_PRODUCT_PATTERNS: tuple[tuple, ...] = (
    ...
    ("Door Mat", "Poly", r"\bpoly doormat\b"),
    ...
    ("Kitchen Mat", "Anti-Fatigue", r"\banti fatigue (?:pvc )?kitchen(?: mat)?\b|\bkitchen pvc mat\b"),
    ("Kitchen Mat", "PVC", r"\bpvc kitchen mat\b"),
    ...
    ("Stepping Stone", "Stone", r"\bstepping stone\b"),
