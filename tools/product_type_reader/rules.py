...
_PRODUCT_PATTERNS: tuple[tuple, ...] = (
    ...
    ("Framed Print", "Paper", r"\bframe width\b|\bembossed paper print\b|\bpaper print\b", FALLBACK_TIER),
    ("Framed Print", "Paper", r"\bframed\b.{0,25}\b(?:print|art|poster|gloss)\b|\b(?:print|art|poster|gloss)\b.{0,25}\bframed\b", FALLBACK_TIER),
    ...
    ("Wall Plaque", "MDF Floating Box", r"\bfloating (?:character |figure )?box\b|\bfloating box\b"),
    ...
    ("Wall Sign", "MDF", r"\b(?:mdf )?(?:door|wall) sign\b|\bmdf sign\b|\bhanging sign\b"),
